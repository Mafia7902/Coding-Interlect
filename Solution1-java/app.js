...
var thefield = data.read();
var spacehip_count = data.ships();
var num_crates = data.crates();
var num_bases = data.bases();
var map_width = data.width();
var map_height = data.height();
console.log(` Spaceship count: ${spacehip_count}, Number of crates: ${num_crates}, Number of bases: ${num_bases}, Y: ${map_width}, X: ${map_height}`)
